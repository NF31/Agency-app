...
@section('content')
    ...
    <section class="miami">
        ...
        <div class="miami-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/villas.miami/appart-miami.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/appart-miami2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restau-paris2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restau-personne.png') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m11.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m12.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m13.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m14.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restaurant-marseille.png') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m15.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m16.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m17.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/m18.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/miami-p8.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/miami-p9.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restau-gastro5.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restau-gastro6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/miami-p2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/miami-p3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/restau-gastro9.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.miami/miami-p6.jpg') }}" alt=""></div>
            </div>
        </div>
