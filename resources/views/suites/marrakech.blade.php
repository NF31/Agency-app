...
@section('title', 'Marrakech')

@section('content')

    <section class="marrakech">

        <div class="marrakech-m fade-in">
        </div>

        <div class="marrakech-titre">
            <div class="left">
                <h1>Marrakech</h1>
            </div>
            <div class="center">
        ...
        <div class="marrakech-description">
            <div class="left">
                <h1>TOP VIEW</h1>
            </div>
            <div class="center">
        ...
        <div class="marrakech-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech5.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech8.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech9.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-marrakech/marrakech10.jpg') }}" alt=""></div>


            </div>
        </div>

        <div class="marrakech-see">
            <h2>See also</h2>
