...
@section('content')
    ...
    <section class="tokyo">
        ...
        <div class="tokyo-m fade-in">
        </div>

        <div class="tokyo-titre">
            <div class="left">
                <h1>Tokyo</h1>
            </div>
            <div class="center">
        ...
        <div class="tokyo-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo5.jpeg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo7.webp') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo9.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-tokyo/tokyo11.jpg') }}" alt=""></div>
