...
@section('content')
    ...
    <section class="bali">
        <div class="bali-m fade-in">
        </div>

        <div class="bali-titre">
            <div class="left">
                <h1>Bali</h1>
            </div>
            <div class="center">
        ...
        <div class="bali-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/suits-bali/bali1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali5.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali7.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali8.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-bali/bali10.jpg') }}" alt=""></div>
