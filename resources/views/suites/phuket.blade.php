...
@section('content')
    ...
    <section class="phuket">

        <div class="phuket-m fade-in">
        </div>

        <div class="phuket-titre">
            <div class="left">
                <h1>Marrakech</h1>
            </div>
            <div class="center">
        ...
        <div class="phuket-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/suits-phuket/phuket1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket9.webp') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket10.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket7.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket9.webp') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-phuket/phuket4.jpg') }}" alt=""></div>


            </div>
        </div>

        <div class="phuket-see">
            <h2>See also</h2>
