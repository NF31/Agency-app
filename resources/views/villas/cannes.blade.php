...
@section('title', 'Cannes')

@section('content')

    <section class="cannes">

        <div class="house-m fade-in">
        </div>

        <div class="cannes-titre">
            <div class="left">
                <h1>Cannes</h1>
            </div>
            <div class="center">
        ...
        <div class="cannes-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/villas.cannes/c4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c5.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c2.png') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c7.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c8.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c9.png') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c10.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c11.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c12.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c13.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c14.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c15.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c16.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c17.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c18.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c19.webp') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c21.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.cannes/c20.jpg') }}" alt=""></div>
            </div>
        </div>


        <div class="cannes-see">
            <h2>See also</h2>
