...
@section('title', 'Nottingham')

@section('content')

    <section class="nottingham">

        <div class="nottingham-m fade-in">
        </div>

        <div class="nottingham-titre">
            <div class="left">
                <h1>Nottingham</h1>
            </div>
            <div class="center">
        ...
        <div class="nottingham-description">
            <div class="left">
                <h1>TOP VIEW</h1>
            </div>
            <div class="center">
        ...
        <div class="nottingham-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images//suits-nottingham/nott1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott7.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott8.jpeg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott10.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/suits-nottingham/nott11.jpg') }}" alt=""></div>


            </div>
        </div>

        <div class="nottingham-see">
            <h2>See also</h2>
