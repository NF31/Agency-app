...
@section('title', 'Birmingham')

@section('content')

    <section class="birmingham">

        <div class="house-m fade-in">
        </div>

        <div class="birmingham-titre">
            <div class="left">
                <h1>Birmingham</h1>
            </div>
            <div class="center">
        ...
        <div class="birmingham-description">
            <div class="left">
                <h1>TOP VIEW</h1>
            </div>
            <div class="center">
        ...
        <div class="birmingham-gallery">
            <h2>Gallery</h2>
            <div class="grid-wrapper">
                <div class=""><img src="{{ asset('images/villas.birmingham/b3.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b1.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b2.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b4.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b5.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b6.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b7.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b8.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b9.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b10.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b11.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b12.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b13.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b14.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b15.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b16.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b17.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b18.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b19.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b20.jpg') }}" alt=""></div>
                <div class=""><img src="{{ asset('images/villas.birmingham/b21.jpg') }}" alt=""></div>
            </div>
        </div>


        <div class="birmingham-see">
            <h2>See also</h2>
